<template>
  <Transition>
    <div v-if="showUploadScreen" class="absolute flex justify-center items-center w-screen h-screen bg-black z-[9999] bg-opacity-80 left-0">
      <div class="bg-blue-600 flex justify-center flex-col rounded py-4 px-8 relative border-dotted border-white_500 border-2">
        <div class="absolute top-[-75px] left-0 translate-x-[25%]">
          <div class="flex">
            <img class="-rotate-[25deg] relative left-[25px] top-[10px] opacity-90" src="/src/assets/file1.svg" alt="File">
            <img class="relative z-50" src="/src/assets/file2.svg" alt="File">
            <img class="rotate-[25deg] relative right-[25px] top-[10px] opacity-90" src="/src/assets/file3.svg" alt="File">
          </div>
        </div>
        <h1 class="mt-10 font-bold text-white_500 text-2xl text-center">Upload to #général</h1>
