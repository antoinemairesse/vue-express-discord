<template>
  <DialogWrapper :title="$tc('server.ban', 2, {username: user?.username})" v-model="show">
    ...
    <div class="flex gap-4 justify-end items-center">
      ...
      <button type="submit" class="bg-red-500 text-white_500 rounded px-6 py-2.5" @click="kick">{{ $t('ban') }}</button>
    </div>
  </DialogWrapper>
</template>
