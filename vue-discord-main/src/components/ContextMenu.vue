<template>
  ...
  <div v-if="showContextMenu && condition" id="member-context-menu"
    ...
    <template v-for="item in items">
      <span
          ...
          :class="[{'text-red-500 hover:bg-red-600': item.warning}, {'hover:bg-purple': !item.warning}]"
  ...
  methods: {
    handleContextMenu($event, item) {
      ...
      this.$nextTick(() => {
        ...
        const w = document.getElementById('member-context-menu').getBoundingClientRect().width;
