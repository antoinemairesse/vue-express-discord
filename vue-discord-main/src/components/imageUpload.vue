<template>
  ...
  >
    ...
    >
      ...
      <i
        v-else
        class="group-hover:text-white_500 text-label ri-image-add-line text-5xl"
      ></i>
      <span
        class="group-hover:text-white_500 text-label text-center font-bold uppercase pt-4"
        >Upload</span
      >
    </div>
    <input
